ADMIN_RULES_TEXT = """
🤖 **Ustoz (Admin) uchun botdan foydalanish bo'yicha to'liq qo'llanma va qoidalar**

Assalomu alaykum! Bu bot orqali siz o'quvchilaringizni va guruhlaringizni to'liq nazorat qila olasiz. Quyida botning har bir bo'limi va undan qanday foydalanish haqida batafsil ma'lumot berilgan:

1️⃣ **📢 Hammaga xabar yuborish**
Bu tugma yordamida botdagi BARCHA faol o'quvchilarga bitta xabar yuborishingiz mumkin. E'lonlar, bayram tabriklari yoki umumiy o'zgarishlar haqida xabar berish uchun juda qulay.

2️⃣ **👥 Guruhlar va O'quvchilar**
Bu tugma orqali siz:
